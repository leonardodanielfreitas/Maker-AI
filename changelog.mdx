...
News from the Maker engineering team.
...
<Update label="06/12/2025" description="">
  ...
  **Improvements**
  ...
  - Added in-product feedback system - click the thumbs down button when edits cause issues to help us improve Maker’s AI for everyone.
